// TODO: See if I can make this a bit easier to read.
import * as React from "react";

function BtIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg version="1.1" id="BT_Logo" x="0px" y="0px"
        viewBox="0 0 521.6 521.6" stroke="currentColor" fill="currentColor" {...props}>
